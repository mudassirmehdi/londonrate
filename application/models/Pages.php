...
class Pages extends CI_Controller {
	...
	public function viewpage($pagename)
	{
		...
		$arrPage = $this->Page_model->getPageData($pagename);
		$data['title']=$pagename;	
	...
	public function faq()
	{
		...
		$arrFaq = $this->Page_model->getAllFaq();
		$data['title']="FAQ";	
		$data['arrFaq']=$arrFaq;	
	...
	public function privacy()
	{
		...
		$arrPage = $this->Page_model->getPageData('Privacy');
		$data['title']="FAQ";	
		$data['arrPage']=$arrPage ;	
	...
	public function terms()
	{
		...
		$arrPage = $this->Page_model->getPageData('Terms');
		$data['title']="Terms & Conditions";	
		$data['arrPage']=$arrPage ;	
