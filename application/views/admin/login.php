...
<head>
    ...
    <meta name="description" content="London Rate Ip Valuation">
    <meta name="keywords" content="London Rate Ip Valuation">
    <meta name="author" content="pixelstrap">
    <link rel="icon" href="<?php echo base_url('templates/frontend/');?>/images/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo base_url('templates/frontend/');?>/images/favicon.ico" type="image/x-icon">
    <title>Londonrate - Admin Login</title>
    ...
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('templates/admin/');?>assets/css/themify.css">

    <!-- slick icon-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('templates/admin/');?>assets/css/slick.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('templates/admin/');?>assets/css/slick-theme.css">

    <!-- jsgrid css-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('templates/admin/');?>assets/css/jsgrid.css">
                ...
                <div class="col-md-5 p-0 card-left">
                    <div class="card bg-primary">
                        <div class="admin-logo">
                            <img src="<?php echo base_url();?>templates/admin/assets/images/logo.png" alt="">
                        </div>

                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Welcome to Londonrate</h3>
                                    <p>Online IP-Valuation in 10 minutes</p>
                                </div>
                            </div>
                            <!--<div>
                                <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
									...
									<?php }?>
									<input type="hidden"  name="user_type" id="user_type" value="BusinessOwner" />
									 	
										<div class="form-group">
											<input required="" name="username" type="text" class="form-control" placeholder="Username/ EmailAddress" id="exampleInputEmail1">
										 </div>
                                        <div class="form-group">
                                            <input required="" name="admin_password" type="password" class="form-control" placeholder="Password">
                                        </div>
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                <input type="checkbox" class="custom-control-input" id="customControlAutosizing">
                                               <a href="<?php echo base_url();?>backend/login/forgotpassword" class="btn btn-default forgot-pass">Forgot password</a>
                                            </div>
                                        </div>
...
<script src="<?php echo base_url('templates/admin/');?>assets/js/slick.js"></script>

<!-- Jsgrid js-->
<script src="<?php echo base_url('templates/admin/');?>assets/js/jsgrid/jsgrid.min.js"></script>
<script src="<?php echo base_url('templates/admin/');?>assets/js/jsgrid/griddata-invoice.js"></script>
<script src="<?php echo base_url('templates/admin/');?>assets/js/jsgrid/jsgrid-invoice.js"></script>
