                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <input class="form-control col-md-7" id="pakage_name" name="pakage_name" type="text" value=""  required>
                                            </div>
                                            <div class="form-group row">
                                                <label for="full_description" class="col-xl-3 col-md-4"><span>*</span> Package Full description</label>
                                                <textarea class="form-control col-md-7" id="full_description" name="full_description" required></textarea>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input class="form-control col-md-7" id="amount" name="amount" type="number" value=""  required>
                                            </div>
