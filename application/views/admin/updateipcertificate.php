                                     ...
                                     <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <input class="form-control col-md-4" id="cert_name" name="cert_name" type="text" required value="<?php echo $certInfo[0]['cert_name'];?>">
                                            </div>
											<div class="form-group row">
												<label class="col-xl-3 col-md-4"><span></span>Ip Type</label>
												 <select name="typeid" id="typeid"  class="form-control col-md-4"  required >
													...
													<?php if(isset($ipType) && count($ipType)>0)
													{
														...
														{?>
														<option <?php if($certInfo[0]['typeid']==$type['typeid']){ echo 'selected="selected"';}?> value="<?php echo $type['typeid'];?>" ><?php echo $type['type'];?></option>
														<?php }
													}?>
                                            ...
                                            <div class="form-group row">
											 ...
											 <div class="form-group row">
                                              ...
                                              <select class="custom-select col-md-4" name="cert_status" id="cert_status">
                                                    <option value="Active" <?php if($certInfo[0]['cert_status']=="active"){ echo 'selected="selected"';}?>>Active</option>
													<option value="Inactive" <?php if($certInfo[0]['cert_status']=="inactive"){ echo 'selected="selected"';}?>>Inactive</option>
                                                </select>
                                            </div>
