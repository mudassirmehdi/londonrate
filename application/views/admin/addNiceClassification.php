                    ...
                    <div class="card-body">
                      <?php if($this->session->flashdata('success')!=""){?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <input class="form-control col-md-3" id="nice_name" name="nice_name" type="text" value=""  required>
                                            </div>
                        ...
                        <div class="pull-right">
							...
							<a  class="btn btn-primary" href="<?php echo base_url();?>backend/NiceClassification/addNiceClassification">Cancel</a>
                        </div>
						</form>
                    </div>
                </div>
