                ...
                <div class="row">
                    <div class="col-lg-8 col-xl-7 mx-auto">
                        ...
                        <div class="wizard">
                            ...
                            <form role="form" name="frm_users_profile" id="frm_users_profile" class="login-box" method="post">
						...
						<?php }?>
                                            ...
                                            <div class="form-group">
                                                <label>Name *</label>
                                                <input class="form-control" type="text" name="applicant_name" id="applicant_name" value="<?php echo $profiledata[0]['applicant_name'];?>"/>
                                            ...
                                            <div class="form-group">
												...
												foreach($countrylist as $con){?>
													<option value="<?php echo $con['country_id']?>" <?php if($con['country_id']==$profiledata[0]['applicant_country']){echo 'selected="selected"';}?>><?php echo $con['country_name']?></option>
												<?php }
													}?>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label>E-mail *</label>
                                                <input class="form-control" type="email" name="applicant_email" id="applicant_email" value="<?php echo $profiledata[0]['applicant_email'];?>" readonly="readonly"/>
												<span id="err_applicant_email" class="error_class"></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Contact number *</label>
                                                <div class="input-wrap" >
                                                    <select class="vodiapicker" name="applicant_country_code" id="applicant_country_code">
                                                    ...
                                                    <input class="form-control" type="number" name="applicant_contact_number" id="applicant_contact_number" value="<?php echo $profiledata[0]['applicant_contact_number'];?>" readonly="readonly" />
                                            ...
                                            <div class="form-group text-right mt-4 mt-md-5">
                                                <button type="submit" name="btn_update_profile" id="btn_update_profile" class="button next-step">Update</button>
                                            </div>
                                        </div>
                                    </div>
...
$("#applicant_country_code").val(currentvalue);
