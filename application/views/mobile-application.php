   <div class="bread-main">
        ...
        <section class="find-values demo-calc main-padding services-detail">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-6 col-sm-4 col-md-6 col-xl-4 mx-auto">
                        <div class="card">
                            <div class="card-img">
                                <img src="<?php echo base_url('templates/frontend/');?>images/icons/services-mobile.svg" alt="Mobile Application">
                            </div>
                    ...
                    <div class="col-lg-9 mx-auto">
                        <form class="form-card" name="mobapp" id="mobapp" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                    <label class="form-label">Type of Mobile Application *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4"> <label class="form-label">Type of IP Certificate *</label></div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                     <label class="form-label">Protected Industries *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                      <label class="form-label">Rightsholder *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                     <label class="form-label">Total sales, monthly *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                    <label class="form-label">Net profit, monthly *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                     <label class="form-label">How old is the company *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                    <label class="form-label">Total marketing budget, monthly *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                    <label class="form-label">Total salaries, monthly *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group text-center mt-5">
                                <button class="button cls_js_mobile_applications" name="btnCalculate" id="btnCalculate">Calculate Value</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-9 mx-auto text-center">
						...
						<table style="" width="950" cellspacing="0" cellpadding="0" border="1" align="center">		
						<thead>
							<tr>												
