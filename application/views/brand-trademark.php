                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Brand Trademark</li>
                      </ol>
                    </nav>
            ...
            <div class="container"> 
                <div class="row">
                    <div class="col-6 col-sm-4 col-md-6 col-xl-4 mx-auto">
                        <div class="card">
                            <div class="card-img">
                                 <img src="<?php echo base_url('templates/frontend/');?>images/icons/services-brand.svg" alt="Brand Trademark">
                            </div>
                    ...
                    <div class="col-lg-9 mx-auto">
                       <form class="form-card" name="mobapp" id="mobapp" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                            <div class="form-group row align-items-center mb-4">
                                <div class="col-md-4">
                                    <label class="form-label">Type of Brand *</label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="form-group text-center mt-5">
								<button class="button cls_js_brand_trademark" name="btnCalculate" id="btnCalculate">Calculate Value</button>
                            </div>
                        </form>
                    </div>
