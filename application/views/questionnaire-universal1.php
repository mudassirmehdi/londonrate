        ...
        <div class="bread-content container">
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <h1>Request <?php echo ucfirst($session_package_name);?> Certificate</h1>
                ...
                <div class="row">
                    <div class="col-md-9 mx-auto">
                        ...
                        <div class="wizard">
                            <div class="wizard-inner">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation" class="disabled">
                                        <a href="javascript:void(0);" ><span class="round-tab">2</span><i>Company information</i></a>
                                    </li>
                                    <li role="presentation" class="disabled">
                            ...
                            <form role="form" name="frm_questionnaire_universal1" id="frm_questionnaire_universal1" class="login-box" method="post">
                                    ...
                                    <div class="tab-pane active" role="tabpanel" id="step1">
                                        ...
                                        <div class="form-card">
                                            ...
                                            <div class="row form-group align-items-center mb-4 ">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control" type="text" name="applicant_name" id="applicant_name" value="<?php echo $applicant_name;?>"/>
                                                    <span id="err_applicant_name" class="error_class"></span>
                                                </div>
                                            </div> 

                                            <div class="form-group align-items-center mb-4  row">
                                                <div class="col-md-4 text-start"> <label class="form-label">Country of presence *</label></div>
                                                <div class="col-md-8">
                                                    ...
                                                    foreach($countrylist as $con){?>
                                                        <option value="<?php echo $con['country_id']?>" <?php if($con['country_id']==$applicant_country){echo 'selected="selected"';}?>><?php echo $con['country_name']?></option>
                                                    <?php }
                                                        }?>
                                                    </select>
                                                    <span id="err_applicant_country" class="error_class"></span>
                                                </div>
                                            ...
                                            <div class="form-group align-items-center mb-4  row">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control" type="email" name="applicant_email" id="applicant_email" value="<?php echo $applicant_email;?>" <?php if($session_applicant_id>0){ ?> readonly="readonly" <?php }?>/>
                                            ...
                                            <div class="form-group align-items-center mb-4  row">
                                                ...
                                                <div class="input-wrap  col-md-8" >
                                                    ...
                                                    <div class="input-group mb-3">
                                                          <span class="input-group-text" id="basic-addon1">
                                                            ...
                                                            <select class="vodiapicker form-control" name="applicant_country_code" id="applicant_country_code">
                                                          ...
                                                          <input class="form-control" type="number" name="applicant_contact_number" id="applicant_contact_number" value="<?php echo $applicant_contact_number;?>"/>
                                                        </div>
												...
												<span id="err_applicant_country_code" class="error_class"></span>
													<span id="err_applicant_contact_number" class="error_class"></span>
                                            </div>
											
											<input type="hidden" name="session_applicant_id" id="session_applicant_id" 
											value="<?php echo $session_applicant_id;?>" />
											<?php if($session_applicant_id==0){ ?>
											...
											<div class="form-group align-items-center mb-4  row">
                                               <div class="col-md-4 text-start">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control" type="password" name="confirm_applicant_password" id="confirm_applicant_password"/>
                                                    <span id="err_confirm_applicant_password" class="error_class"></span>
                                                </div>
                                            </div>
											
                                            <div class="form-group align-items-center mb-4  mt-4 text-start">
                                                <div class="flex-row">
                                                    <input id="t&c" name="is_terms" type="checkbox" class="custom-checkbox" value="Yes" <?php if("Yes"==$is_terms){echo 'checked="checked"';}?>>
                                                    <label for="t&c" class="custom-checkbox-lable">
                                                        By signing up, you agree to our <a
                                                            href="<?php echo base_url();?>home/terms" target="_blank">
                                                            Terms &amp; Conditions
                                                        </a>
                                                    </label>
                                                </div>
												<span id="err_is_terms" class="error_class"></span>
                                            </div>
                                            <div class="form-group align-items-center mb-4  text-start">
                                                <div class="flex-row">
                                                    <input id="privacy-policy" name="is_privacy" type="checkbox" class="custom-checkbox" value="Yes" <?php if("Yes"==$is_privacy){echo 'checked="checked"';}?>>
                                                    <label for="privacy-policy" class="custom-checkbox-lable">
                                                         <a href="javascript:void(0)" data-toggle="modal" data-target="#privacyModal" class="link">Privacy Policy
                                                        </a>,
                                                            including the use of cookies and transfer of your personal
                                                            information to LondonRate *
                                                    </label>
                                                </div>
												<span id="err_is_privacy" class="error_class"></span>
                                            </div>
											<?php } ?>
                                            <div class="form-group align-items-center mb-4  text-end mt-4 mt-md-5">
                                                <button type="submit" name="btn_applicant_info" id="btn_applicant_info" class="button next-step action-button">Next</button>
                                            </div>
                                        </div>
                                    </div>
...
$("#applicant_country_code1").val(currentvalue);
