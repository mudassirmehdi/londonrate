...
<tbody><tr>
<td style="padding-top:30px;font-family:'Amiri','Sylfaen',serif">Dear <?php echo $applicant_name;?>,</td>
</tr>
<tr>
<td>
<p>Your password has benn change successfully, kindly login with the newly created password.</p>
